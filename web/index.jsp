...
<div id="header">
    ...
    <div id="intro">
        <div id="title">S podporou charitativní dílny <span id="duko">Duko s.r.o.</span> <br/>  <span id="lyosoft">Lyosoft.cz </span> připravilo tuto službu <br/>a jako dobrovolnik <span id="charita">oblastní charity Třebíč </span> podporuji motto <br/> <div id="motto"> I malá pomoc může být velkou podporou.</div></div>
    </div>
</div>
<div id="clear"></div>
...
<div id="main">
    ...
    <span class="title">konzultace v oblasti programovani Java, webové stránky</span>
    <ul>
